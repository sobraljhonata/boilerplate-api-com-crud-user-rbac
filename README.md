...
mkdir boilerplate-api-com-crud-user-rbac

cd boilerplate-api-com-crud-user-rbac

cp ~/Projetos/boilerplate-api-com-crud-user-rbac/jest-integration-config.js ~/Projetos/boilerplate-api-com-crud-user-rbac/jest-unit-config.ts ~/Projetos/boilerplate-api-com-crud-user-rbac/jest.config.ts ~/Projetos/boilerplate-api-com-crud-user-rbac/nodemon.json ~/Projetos/boilerplate-api-com-crud-user-rbac/tsconfig.json ~/Projetos/boilerplate-api-com-crud-user-rbac/.env-exemplo ~/Projetos/boilerplate-api-com-crud-user-rbac/.gitignore ~/Projetos/boilerplate-api-com-crud-user-rbac/tsconfig.build.json ~/Projetos/boilerplate-api-com-crud-user-rbac/tsconfig.spec.json ~/Projetos/boilerplate-api-com-crud-user-rbac/yarn.lock ~/Projetos/boilerplate-api-com-crud-user-rbac

mkdir -p ~/Projetos/boilerplate-api-com-crud-user-rbac/src/core ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/modules

cp -r ~/Projetos/boilerplate-api-com-crud-user-rbac/src/core ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules/auth ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules/users ~/Projetos/boilerplate-api-com-crud-user-rbac/src

cp -r ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules/auth ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules/users ~/Projetos/boilerplate-api-com-crud-user-rbac/src/modules

cp ~/Projetos/projeto-basico-com-crud-usuario/src/server.ts ~/Projetos/boilerplate-api-com-crud-user-rbac/src

cp ~/Projetos/boilerplate-api-com-crud-user-rbac/.env-exemplo ~/Projetos/boilerplate-api-com-crud-user-rbac/.env

cp -r ~/Projetos/boilerplate-api-com-crud-user-rbac/test/factories ~/Projetos/boilerplate-api-com-crud-user-rbac/test/helpers ~/Projetos/boilerplate-api-com-crud-user-rbac/test/integration ~/Projetos/boilerplate-api-com-crud-user-rbac/test

cp -r ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/adapters ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/core ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/middlewares ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit

cp -r ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/modules/auth ~/Projetos/cardapio-digital-api/test/unit/modules/users ~/Projetos/boilerplate-api-com-crud-user-rbac/test/unit/modules
...
sudo rm -rf ~/Projetos/boilerplate-api-com-crud-user-rbac ~/Projetos/boilerplate-api-com-crud-user-rbac ~/Projetos/boilerplate-api-com-crud-user-rbac ~/Projetos/script-python-senac
